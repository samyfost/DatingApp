...
public class MessageRepository : IMessageRepository
    {
        ...
        public async Task<PagedList<MessageDto>> GetMessagesForUser(MessageParams messageParams)
        {
            ...
            {
                "Inbox" => query.Where(u => u.RecieverUsername == messageParams.Username && u.RecieverDeleted == false),
                "Outbox" =>query.Where(u => u.SenderUsername == messageParams.Username && u.SenderDeleted == false),
                _ => query.Where(u => u.RecieverUsername == 
        ...
        public async Task<IEnumerable<MessageDto>> GetMessageThread(string currentUsername, string recieverUsername)
        {
            ...
            && m.RecieverUsername == currentUsername).ToList();

...
namespace API.Data
{
    public class MessageRepository : IMessageRepository
    {
        ...
        public async Task<PagedList<MessageDto>> GetMessagesForUser(MessageParams messageParams)
        {
            ...
            {
                "Inbox" => query.Where(u => u.Reciever.UserName == messageParams.Username && u.RecieverDeleted == false),
                "Outbox" =>query.Where(u => u.Sender.UserName == messageParams.Username && u.SenderDeleted == false),
                _ => query.Where(u => u.Reciever.UserName == 
                messageParams.Username && u.RecieverDeleted == false && u.DateRead == null)
            };
        ...
        public async Task<IEnumerable<MessageDto>> GetMessageThread(string currentUsername, string recieverUsername)
        {
            ...
            && m.Reciever.UserName == currentUsername).ToList();

...
namespace API.SignalR
{
    public class MessageHub : Hub
    {
        ...
        public async Task SendMessage(CreateMessageDto createMessageDto)
        {
            ...
            {
                throw new HubException ("Yu cant send message to yourself");
            }

            var sender= await _unitOfWork.UserRepository.GetUserByUsernameAsync(username);
            var reciever = await _unitOfWork.UserRepository.GetUserByUsernameAsync(createMessageDto.RecieverUsername);
            ...
            if(group.Connections.Any(x => x.Username == reciever.UserName))
            {
                ...
                var connections = await _tracker.GetConnectionsForUser(reciever.UserName);
                if(connections!= null)
                {
